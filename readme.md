...
PostgreSQL повністю відмовився від сканування всієї таблиці.Система одразу знайшла позиції потрібних 508 рядків у структурі індексу і зчитала лише 476 сторінок даних. Чистий час виконання впав до 4.463 мс.
